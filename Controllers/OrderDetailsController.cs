...
namespace WebsiteBanSach.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(WebsiteBanSachContext context)
        {
            _context = context;
        }
        ...
        {
            var websiteBanSachContext = _context.OrderDetail
                .Include(o => o.Product)
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebsiteBanSachContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
