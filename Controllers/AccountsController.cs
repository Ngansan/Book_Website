...
namespace WebsiteBanSach.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(WebsiteBanSachContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Account != null ? 
                          ...
                          Problem("Entity set 'WebsiteBanSachContext.Account'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebsiteBanSachContext.Account'  is null.");
            }
