...
namespace WebsiteBanSach.Controllers
{
    public class CartDetailsController : Controller
    {
        ...
        public CartDetailsController(WebsiteBanSachContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
			...
			var websiteBanSachContext = _context.CartDetail
                .Include(c => c.Cart)
                .Include(c => c.Product)
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebsiteBanSachContext.CartDetail'  is null.");
            }
            var cartDetail = await _context.CartDetail.FindAsync(id);
            if (cartDetail != null)
            {
