...
namespace WebsiteBanSach.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(WebsiteBanSachContext context)
        {
            _context = context;
        }
        ...
        {
            var websiteBanSachContext = _context.Cart.Include(c => c.Account);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebsiteBanSachContext.Cart'  is null.");
            }
            var cart = await _context.Cart.FindAsync(id);
            if (cart != null)
            {
