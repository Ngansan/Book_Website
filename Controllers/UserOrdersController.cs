...
namespace WebsiteBanSach.Controllers
{
    public class UserOrdersController : Controller
    {
        ...
        public UserOrdersController(WebsiteBanSachContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderDate,ReceiverName,PhoneNumber,Address,PaymentMethod,Note,ShippingFee,TotalValue,IsDone,AccountId,EmailAddress")] UserOrder userOrder)
        {
            ...
            htmlBody += $@"</table><p>Tổng giá trị đơn hàng: {userOrder.TotalValue}</p><p>Phí vận chuyển: {userOrder.ShippingFee}</p><p>Tổng cộng: {userOrder.TotalValue + userOrder.ShippingFee}</p><p>Cảm ơn bạn đã mua sắm tại Bookshop!</p></body></html>";
            ...
            using (SmtpClient smtpClient = new SmtpClient("smtp.gmail.com"))
            {
                ...
                mailMessage.From = new MailAddress("cong171002@gmail.com", "Bookshop");
                mailMessage.To.Add(userOrder.EmailAddress);
                mailMessage.Subject = "Đơn hàng của bạn tại Bookshop";
